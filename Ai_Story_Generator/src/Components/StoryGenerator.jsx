...
//       setStoryContext((prevContext) => prevContext + "AI: " + data.response + "\n");
...
//           >
//             {message.sender === "ai" && <FaRobot className="text-gray-500 mr-2 mt-1 text-3xl" />}
//             <div
...
//               {message.text}
//             </div>
//             {message.sender === "user" && <FaUserCircle className="text-blue-500 ml-2 mt-1 text-3xl" />}
//           </div>
//         ))}
//       </div>
//       <div className="p-4 flex bg-gray-100 shadow-md fixed bottom-0 w-full max-w-2xl mx-auto left-1/2 transform -translate-x-1/2">
//       {/* <div className="p-4 flex bg-gray-100 shadow-md sticky bottom-0 w-full"> */}
...
//         </button>
//         <button onClick={() => setShowPopup(true)} className="ml-2 p-3 rounded-lg bg-red-500 text-white hover:bg-red-600 transition-all duration-200">
//           End
//         </button>
//       </div>
//  {showPopup && (
...
//         <pre className="whitespace-pre-wrap text-sm text-gray-700">{storyContext}</pre>
//       </div>
//     </div>
//   </div>
// )}
